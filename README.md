...
| [Frontend University](godbrain_core/skill_lab/README.md) | 3-year högskoleingenjör (6 terms) + browser examiner + Creation Gallery | React (Next for sites, Vite for apps); Qwen on `:8888` is the learner; capstone is the exam once; later tracks are a named GO |
