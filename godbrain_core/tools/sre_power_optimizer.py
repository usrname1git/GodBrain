...
print("======================================================")
print("[GodBrain] SRE POWER PLAN & KERNEL OBLITERATOR INITIALIZED")
print("======================================================")

PS_SCRIPT_PATH = os.path.abspath("godbrain_nuke_powersaving.ps1")
...
print(f"[+] Successfully generated optimization payload: {PS_SCRIPT_PATH}")
