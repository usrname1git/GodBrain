...
$arg = "-NoLogo -NoProfile -NoExit -File `"$PSScriptRoot\Invoke-FrontendGym.ps1`" -Command dashboard"
...
Start-ScheduledTask -TaskName "GodBrainCreationLab"
Write-Host "Scheduled task GodBrainCreationLab started. Open http://127.0.0.1:4177"
